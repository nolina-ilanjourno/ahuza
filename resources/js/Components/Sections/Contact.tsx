                        ...
                        <div className="row g-lg-10 gy-5 align-items-center">
                                        ...
                                        >
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <textarea
                                                    className="form-control"
                                                    id="messageTextarea"
                                                    placeholder="Ecivez votre message ici..."
                                                    rows={4}
                                                    required
                                                ></textarea>
                                                <div className="invalid-feedback">
                            ...
                            <div className="col-md-6">
                                ...
                                <div>
                                    <a
                                        href="#!"
                                        className="text-reset btn btn-instagram btn-icon"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="16"
                                    ...
                                    <a
                                        href="#!"
                                        className="text-reset btn btn-twitter btn-icon"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="16"
                                    ...
                                    <a
                                        href="#!"
                                        className="text-reset btn btn-youtube btn-icon"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="16"
